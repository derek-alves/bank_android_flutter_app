...
abstract class FeatureFlutterApi {
  ...
  static void setUp(FeatureFlutterApi? api, {BinaryMessenger? binaryMessenger, String messageChannelSuffix = '',}) {
    messageChannelSuffix = messageChannelSuffix.isNotEmpty ? '.$messageChannelSuffix' : '';
    {
      final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.flutter_module.FeatureFlutterApi.navigateTo$messageChannelSuffix', pigeonChannelCodec,
      ...
      if (api == null) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.flutter_module.FeatureFlutterApi.navigateTo was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final Route? arg_route = (args[0] as Route?);
          assert(arg_route != null,
              'Argument for dev.flutter.pigeon.flutter_module.FeatureFlutterApi.navigateTo was null, expected non-null Route.');
          try {
    ...
    {
      final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.flutter_module.FeatureFlutterApi.syncFeatures$messageChannelSuffix', pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        pigeonVar_channel.setMessageHandler(null);
      } else {
        pigeonVar_channel.setMessageHandler((Object? message) async {
          try {
            final List<Feature> output = api.syncFeatures();
